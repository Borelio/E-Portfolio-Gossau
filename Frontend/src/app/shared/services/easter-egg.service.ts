...
export enum EasterEgg {
  ...
  Firework = 'firework',
  Rick = 'rick',
  Nico_Ist_Der_Beste = 'nico ist der beste',
  NicoIstDerBeste = 'nicoistderbeste',
}
  ...
  keyPressed(key: string) {
    ...
    switch (this.correctTypedText) {
      ...
      case EasterEgg.Firework:
        ...
        break;
      case EasterEgg.Nico_Ist_Der_Beste:
      case EasterEgg.NicoIstDerBeste:
        this.raceService.boost(true);
    }
